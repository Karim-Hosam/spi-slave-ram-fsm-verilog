...
// Date        : Wed Aug  6 00:33:45 2025
// Host        : DESKTOP-PHD9ORN running 64-bit major release  (build 9200)
// Command     : write_verilog {F:/D/DigitalCourse/Project2/SPI DEMO.v}
// Design      : SPI_Wrapper
...
module SPI_Slave
  ...
  wire \FSM_onehot_ns_reg[2]_i_2_n_0 ;
  wire \FSM_onehot_ns_reg[2]_i_3_n_0 ;
  wire \FSM_onehot_ns_reg[3]_i_2_n_0 ;
  wire \FSM_onehot_ns_reg[3]_i_3_n_0 ;
  ...
  LUT1 #(
    ...
    \FSM_onehot_cs[4]_i_1 
       (.I0(rst_n_IBUF),
        .O(clr_counter_reg_0));
  (* FSM_ENCODED_STATES = "CHK_CMD:00010,WRITE:10000,READ_ADD:00100,READ_DATA:01000,IDLE:00001" *) 
  (* KEEP = "yes" *) 
  FDSE #(
    .INIT(1'b1)) 
    \FSM_onehot_cs_reg[0] 
  ...
  LUT2 #(
    .INIT(4'h1)) 
    \FSM_onehot_ns_reg[2]_i_2 
       (.I0(SS_n_IBUF),
        .I1(\FSM_onehot_cs_reg_n_0_[0] ),
        .O(\FSM_onehot_ns_reg[2]_i_2_n_0 ));
  LUT2 #(
    .INIT(4'h1)) 
    \FSM_onehot_ns_reg[2]_i_3 
       (.I0(\FSM_onehot_cs_reg_n_0_[4] ),
        .I1(\FSM_onehot_cs_reg_n_0_[1] ),
        .O(\FSM_onehot_ns_reg[2]_i_3_n_0 ));
  (* XILINX_LEGACY_PRIM = "LD" *) 
  LDCE #(
    .INIT(1'b0)) 
    \FSM_onehot_ns_reg[3] 
  ...
  LUT4 #(
    .INIT(16'h0010)) 
    \FSM_onehot_ns_reg[3]_i_2 
       (.I0(\FSM_onehot_cs_reg_n_0_[1] ),
        .I1(\FSM_onehot_cs_reg_n_0_[4] ),
        .I2(out),
        .I3(\FSM_onehot_cs_reg_n_0_[2] ),
        .O(\FSM_onehot_ns_reg[3]_i_2_n_0 ));
  LUT2 #(
    .INIT(4'h7)) 
    \FSM_onehot_ns_reg[3]_i_3 
       (.I0(D),
        .I1(\FSM_onehot_cs_reg_n_0_[1] ),
        .O(\FSM_onehot_ns_reg[3]_i_3_n_0 ));
  (* XILINX_LEGACY_PRIM = "LD" *) 
  LDCE #(
    .INIT(1'b0)) 
    \FSM_onehot_ns_reg[4] 
  ...
  Up_Counter counter_inst
       (.D({counter_inst_n_14,counter_inst_n_15,counter_inst_n_16,counter_inst_n_17}),
        .E({counter_inst_n_3,counter_inst_n_4,counter_inst_n_5,counter_inst_n_6,counter_inst_n_7,counter_inst_n_8,counter_inst_n_9,counter_inst_n_10,counter_inst_n_11,counter_inst_n_12}),
        .\FSM_onehot_cs_reg[0] (\FSM_onehot_ns_reg[2]_i_2_n_0 ),
        .\FSM_onehot_cs_reg[1] (\FSM_onehot_ns_reg[3]_i_3_n_0 ),
        .\FSM_onehot_cs_reg[1]_0 (\FSM_onehot_ns_reg[3]_i_2_n_0 ),
        .\FSM_onehot_cs_reg[1]_1 (\FSM_onehot_ns_reg_n_0_[1] ),
        .\FSM_onehot_cs_reg[1]_2 (clr_counter_i_2_n_0),
        .\FSM_onehot_cs_reg[2] (\rx_data_reg[0]_i_2_n_0 ),
        .\FSM_onehot_cs_reg[3] (rx_valid_i_1_n_0),
        .\FSM_onehot_cs_reg[4] (\FSM_onehot_ns_reg[2]_i_3_n_0 ),
        .MOSI(D),
        .Q(Q),
        .SS_n_IBUF(SS_n_IBUF),
        .clk_IBUF_BUFG(clk_IBUF_BUFG),
        .clr_counter_reg(counter_inst_n_20),
        .clr_counter_reg_0(clr_counter_reg_n_0),
        .enable_counter_reg(counter_inst_n_18),
        .enable_counter_reg_0(enable_counter_reg_n_0),
        .out({\FSM_onehot_cs_reg_n_0_[4] ,out,\FSM_onehot_cs_reg_n_0_[2] ,\FSM_onehot_cs_reg_n_0_[1] ,\FSM_onehot_cs_reg_n_0_[0] }),
        .rd_addr_Done_reg(counter_inst_n_19),
        .rd_addr_Done_reg_0(rd_addr_Done_reg_n_0),
        .rst_n_IBUF(rst_n_IBUF),
        .rx_valid_reg(counter_inst_n_13),
        .tx_valid_reg(tx_valid_reg),
        .tx_valid_reg__0(enable_counter_i_2_n_0));
  LUT6 #(
...
module SPI_Wrapper
  ...
  Single_Port_Sync_RAM ram_inst
       (.E(spi_slave_inst_n_17),
        ...
        .rst_n_IBUF(rst_n_IBUF),
        .\rx_data_reg[8] (spi_slave_inst_n_15),
        .\rx_data_reg[8]_0 (spi_slave_inst_n_6),
        .rx_valid_reg(spi_slave_inst_n_18),
        .tx_valid_reg(tx_valid_reg));
  ...
  SPI_Slave spi_slave_inst
       (.D(MOSI_IBUF),
        ...
        .WEA(mem),
        .clk_IBUF_BUFG(clk_IBUF_BUFG),
        .clr_counter_reg_0(spi_slave_inst_n_2),
        .\count_reg[2] (ram_inst_n_1),
        .mem_reg(spi_slave_inst_n_15),
        .out(spi_slave_inst_n_0),
        .\rd_addr_reg[7] (ram_din_reg),
        .\rd_addr_reg[7]_0 (spi_slave_inst_n_18),
        .rst_n_IBUF(rst_n_IBUF),
        .tx_valid_reg(tx_valid_reg),
        .tx_valid_reg__0(spi_slave_inst_n_6));
endmodule
...
module Up_Counter
   (Q,
    ...
    tx_valid_reg__0,
    \FSM_onehot_cs_reg[1]_1 ,
    \FSM_onehot_cs_reg[1]_2 ,
    \FSM_onehot_cs_reg[3] ,
    clk_IBUF_BUFG);
  output [2:0]Q;
  output [9:0]E;
  ...
  input tx_valid_reg;
  input [4:0]out;
  input \FSM_onehot_cs_reg[2] ;
  input \FSM_onehot_cs_reg[0] ;
  input \FSM_onehot_cs_reg[1] ;
  input rd_addr_Done_reg_0;
  input \FSM_onehot_cs_reg[4] ;
  input SS_n_IBUF;
  input \FSM_onehot_cs_reg[1]_0 ;
  input [0:0]MOSI;
  input [0:0]enable_counter_reg_0;
  input tx_valid_reg__0;
  input [0:0]\FSM_onehot_cs_reg[1]_1 ;
  input \FSM_onehot_cs_reg[1]_2 ;
  ...
  wire [0:0]\FSM_onehot_cs_reg[1]_1 ;
  wire \FSM_onehot_cs_reg[1]_2 ;
  wire \FSM_onehot_cs_reg[2] ;
  wire \FSM_onehot_cs_reg[3] ;
  wire \FSM_onehot_cs_reg[4] ;
  ...
  LUT6 #(
    ...
    \FSM_onehot_ns_reg[2]_i_1 
       (.I0(\FSM_onehot_cs_reg[0] ),
        .I1(\FSM_onehot_ns_reg[4]_i_3_n_0 ),
        .I2(\FSM_onehot_cs_reg[1] ),
        .I3(rd_addr_Done_reg_0),
        .I4(out[2]),
        .I5(\FSM_onehot_cs_reg[4] ),
        .O(D[1]));
  LUT6 #(
    ...
    \FSM_onehot_ns_reg[3]_i_1 
       (.I0(out[0]),
        ...
        .I4(\FSM_onehot_cs_reg[1] ),
        .I5(rd_addr_Done_reg_0),
        .O(D[2]));
  LUT6 #(
    .INIT(64'h00050000000C000C)) 
  ...
  LUT6 #(
    .INIT(64'hFFFF773F00007730)) 
    clr_counter_i_1
       (.I0(\FSM_onehot_cs_reg[1]_1 ),
        .I1(\FSM_onehot_cs_reg[1]_2 ),
        .I2(\FSM_onehot_cs_reg[3] ),
        .I3(out[0]),
        .I4(clr_counter_i_3_n_0),
